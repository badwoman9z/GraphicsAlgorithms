...
#include"utils.h"
void BackWorldPosPass::RenderCube() {
...
void BackWorldPosPass::init()
{
    ...
    backFace = std::make_shared<Texture>(GL_RGB16F, GL_FLOAT, GL_RGB, scene->SCR_WIDTH, scene->SCR_HEIGHT);
    ...
    RenderManager::get_instance().regisiterTexture("textureBack", backFace->ID);
}

void BackWorldPosPass::update()
{
