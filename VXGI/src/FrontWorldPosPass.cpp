...
#include"utils.h"
void FrontWorldPosPass::RenderCube() {
...
void FrontWorldPosPass::init()
{
    ...
    frontFace =std::make_shared<Texture>(GL_RGB16F, GL_FLOAT, GL_RGB, scene->SCR_WIDTH, scene->SCR_HEIGHT);
    ...
    RenderManager::get_instance().regisiterTexture("textureFront", frontFace->ID);
}

void FrontWorldPosPass::update()
{
